      ...
      <div class="authentication-inner py-6">
        ...
        <div class="card p-md-7 p-1">
          ...
          <div class="card-body mt-1">
            <h4 class="mb-1">Welcome to The Vendors! 👋</h4>
            ...
            ?>
              <div class="text-center mb-5">
                ...
                <span class="text-danger">Salesman Login not allowed</span>
              </div>
            <?php
            }
            ?>
            <form class="mb-5" action="" method="POST">
              <div class="form-floating form-floating-outline mb-5">
                <input type="text" onchange="remove_invalid()" onkeydown="remove_invalid()" onkeyup="remove_invalid()" class="form-control <?php if (isset($_GET['err'])) {
                                                                                                                                              echo 'is-invalid';
                                                                                                                                            } ?>" id="email" name="email-username" placeholder="Enter your email or username" autofocus />
                ...
                <div class="form-password-toggle">
                  <div class="input-group input-group-merge">
                    <div class="form-floating form-floating-outline">
                      <input type="password" onchange="remove_invalid()" onkeydown="remove_invalid()" onkeyup="remove_invalid()" id="password" class="form-control <?php if (isset($_GET['err'])) {
                                                                                                                                                                      echo 'is-invalid';
              ...
              <div class="mb-5">
                <button name="login_submit" class="btn btn-primary d-grid w-100" type="submit">Sign in</button>
              </div>
            </form>
            <?php
            require('includes/php/functions_db.php');
            if (isset($_POST['login_submit'])) {
              $r = login($_POST['email-username'], $_POST['password']);
              if ($r == 1) {
                session_start();
            ...
            ?>
              ...
              <?php
                ...
                <script>
                  window.location.href = 'http://' + window.location.host + '/thevendors/html/admin/login.php?err';
                </script>
              <?php
              } else { ?>
                <script>
                  window.location.href = 'http://' + window.location.host + '/thevendors/html/admin/login.php?notallowed';
                </script>
            <?php  }
            }
            ?>
