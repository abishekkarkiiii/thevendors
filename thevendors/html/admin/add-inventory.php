                            ...
                            <div class="card mt-3">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <?php
                                            $product = mysqli_query($company_db, 'SELECT * FROM products');
                                            while ($row = mysqli_fetch_assoc($product)) { ?>
                                                <tr>
                                                    <td><input type="text" name="product_id[]" value="<?= $row['product_id'] ?>" class="form-control" readonly></td>
                                                    <td><input type="text" value="<?= $row['product_name'] ?>" id="product_id" class="form-control" readonly></td>
                                                    <td><input type="number" name="crt[]" value="0" class="form-control"></td>
                                                    <td><input type="number" name="pcs[]" value="0" class="form-control"></td>
                                                </tr>
                                            <?php }
                                            ?>
                                            <tr>
