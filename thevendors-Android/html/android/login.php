            ...
            <div class="authentication-inner py-6">
                ...
                <div class="card p-md-7 p-1">
                    ...
                    <div class="card-body mt-1">
                        ...
                        <form class="mb-5" action="includes/functions_db.php" method="POST">
                            ...
                            if (isset($_GET['err'])) { ?>
                                <div class="mb-2 text-center text-danger">Incorrect Username or Password</div>
                                <?php  }
                                ?><?php
                                    if (isset($_GET['notallowed'])) { ?>
                                <div class="mb-2 text-center text-danger">Admin and Distributor login not allowed</div>
                            <?php  }
                            ?>
                            <div class="mb-5">
